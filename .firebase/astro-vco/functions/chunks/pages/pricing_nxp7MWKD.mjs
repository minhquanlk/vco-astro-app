/* empty css                             */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, e as renderComponent } from '../astro_CIO9HP5M.mjs';
import 'kleur/colors';
import 'html-escaper';
...
}, "D:/vco2024/web/astro-node/src/components/ToggleSwitch.astro", void 0);
...
const $$PricingPlan = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="container px-4 pt-24 mx-auto md:pt-32 lg:px-0 dark:bg-zinc-900"> <h1 class="mb-3 text-3xl font-bold text-gray-900 sm:text-4xl sm:leading-none sm:tracking-tight dark:text-white">
...
}, "D:/vco2024/web/astro-node/src/modules/PricingPlan.astro", void 0);
